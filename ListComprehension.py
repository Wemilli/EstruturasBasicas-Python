'''Avaliando o estoque de uma empresa. Vamos considerar que todos os produtos dessa empresa são comprados em lotes de 500 unidades.
...
lista_pedido2 = [(produto,1000) if qtde < 200 else (produto,500) for produto, qtde in estoque]
print(lista_pedido2)
